<h2><a href="https://leetcode.com/problems/distance-between-bus-stops/">1184. Distance Between Bus Stops</a></h2><h3>Easy</h3><hr><div><p>A bus&nbsp;has <code>n</code> stops numbered from <code>0</code> to <code>n - 1</code> that form&nbsp;a circle. We know the distance between all pairs of neighboring stops where <code>distance[i]</code> is the distance between the stops number&nbsp;<code>i</code> and <code>(i + 1) % n</code>.</p>
